...
👋 Привет, меня зовут Кирилл /n
🌍 Я живу в городе Рязань /n
👨‍🎓 В настоящие время учусь в академии нейросетей The Founder
📞 Вы можете связаться со мной по TG: @lamauspex
...
## PET проекты:
📌 **Помощник при выборе фильма на вечер** 
Создал чат-бота, который способен рекомендовать фильмы, классифицировать жанры, случайным образом выбирать цитаты и предоставлять рекомендации на основе предпочтений пользователя. [Ссылка на проект](https://github.com/lamauspex/kino_bot/blob/master/README.md)
